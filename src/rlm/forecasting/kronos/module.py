"""
Vendored neural-network building blocks from the Kronos project.

Original source: https://github.com/DGator86/Kronos  (MIT licence)
Copied verbatim; only this header comment was added.
"""
import math
...
class BinarySphericalQuantizer(nn.Module):
    ...
    def forward(self, z, collect_metrics=True):
        ...
        return (
            ...
            {"H": cb_entropy, "used_codes": used_codes, "indices": indices,
             "group_indices": group_indices, "avg_prob": avg_prob}
        )
