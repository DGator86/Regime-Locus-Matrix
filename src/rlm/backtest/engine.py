        ...
        *,
        ...
        for bar_index, (ts, row) in enumerate(features.iterrows()):
            ...
            decision = decide_trade_for_bar(
                ...
                kronos_confidence_weight=rc.kronos_confidence_weight,
                hmm_confidence_weight=rc.hmm_confidence_weight,
                kronos_transition_penalty=rc.kronos_transition_penalty,
                kronos_epistemic_disable_threshold=rc.kronos_epistemic_disable_threshold,
                kronos_aleatoric_size_penalty=rc.kronos_aleatoric_size_penalty,
