...
class ChallengeEngine:
    ...
    def _evaluate_position(
        ...
        # Arm from peak as well as the current mark. Mark refresh (Telegram
        # /positions, ``rlm challenge --status``) can raise peak_premium_mult
        # without setting trail_armed; stage-threshold moves can also leave a
        # peak above the new activate level while the live mult has already
        # retraced. Without this, trail exits are skipped entirely.
