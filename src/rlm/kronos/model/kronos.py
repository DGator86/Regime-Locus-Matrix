...
from rlm.kronos.model.module import (
    BSQuantizer,
...
def auto_regressive_inference(
    ...
    When *return_all_paths* is True the per-sample predictions are returned
    **before** averaging, with shape ``(batch, sample_count, seq_len, feat)``.
    This is the RLM extension used for regime confidence and probabilistic
    forecasting.
    """
    with torch.no_grad():
