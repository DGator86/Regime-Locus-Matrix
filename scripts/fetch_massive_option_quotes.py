#!/usr/bin/env python3
"""
Massive option NBBO quotes (paginated) → Parquet under:

    data/options/{UNDERLYING}/quotes/
...
from rlm.datasets.massive_options_parquet import fetch_option_quotes_to_parquet
...
def main() -> int:
    ...
    p.add_argument("--timestamp-gte", required=True)
    ...
    try:
        out = fetch_option_quotes_to_parquet(
            client,
            args.option_ticker,
