...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Fetch historical stock bars from Interactive Brokers"
    )
    ...
    parser.add_argument(
        "--what", default="TRADES", dest="what_to_show", help="TRADES, MIDPOINT, etc."
    )
    parser.add_argument(
        "--end", default="", dest="end_datetime", help="End datetime (IB format); empty = now"
    )
